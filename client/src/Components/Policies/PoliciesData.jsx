...
const PoliciesData = () => {
  return (
    <Box>
      <div className="text-center p-5 pb-10 mb-5">
        <div className="px-12">
          <ol className="text-xl font-medium">
            <p>
              ...
              dummy text Lorem Ipsum is a dummy text Lorem Ipsum is a dummy text
              Lorem Ipsum is a dummy text Lorem Ipsum is a dummy text Lorem
              Ipsum is a dummy text Lorem Ipsum is a dummy text Lorem Ipsum is a
              dummy text Lorem Ipsum is a dummy text Lorem Ipsum is a dummy text
              Lorem Ipsum is a dummy text Lorem Ipsum is a dummy text Lorem
              ...
              Lorem Ipsum is a dummy text Lorem Ipsum is a dummy text Lorem
              Ipsum is a dummy text Lorem Ipsum is a dummy text Lorem Ipsum is a
              dummy text Lorem Ipsum is a dummy text Lorem Ipsum is a
              dummy text Lorem Ipsum is a dummy text Lorem Ipsum is a
